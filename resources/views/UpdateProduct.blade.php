                                    ...
                                    <div class="boxform">
                                        <div>
                                            <div class="formulario">
                                                <div>
                                                    <img src="{{$iteninfo[0] ->product_image}}"/>
                                                    <h1>Atualizar Cadastro de Produtos</h1>
                                                    <h4>Personalize seu cadastro </h4>
                                                </div>
                                                <form enctype='multipart/form-data' method="POST" action="./update/action">
                                                    @csrf
                                                        <input name="name" type="text" placeholder="Nome do Produto" value="{{$iteninfo[0] ->productname}}"> </input>
                                                        <input name="image" type="text" placeholder="Link Imagem do Produto" value="{{$iteninfo[0] ->product_image}}"> </input>

                                                        <input name="description" type="text" placeholder="Descricao do Produto" value="{{$iteninfo[0] ->product_description}}"> </input>
                                                        <input name="value" type="number" placeholder="Valor Normal do Produto" value="{{$iteninfo[0] ->product_price}}"> </input>
                                                        <input name="promovalue" type="number" placeholder="Valor Promocional do Produto" value="{{$iteninfo[0] ->promotion_price}}"> </input>
                                                        <input type="submit" class="bt btgreen" value="Submeter Dados " />
                                                </form>
                                            </div>
                                        </div>
                                    </div>
