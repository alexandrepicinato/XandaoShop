                                        ...
                                        <div>
                                            <div class="formulario">
                                                <div>
                                                    ...
                                                    <h1>Cadastro seu Portifolio </h1>
                                                    <h4>Crie Seu Portifolio</h4>
                                                </div>
                                                <form enctype='multipart/form-data' method="POST" action="/login/cad/action">
                                                    @csrf
                                                        <input name="name" type="text" placeholder="Nome da Loja"> </input>
                                                        <input name="namefantasy" type="text" placeholder="Nome Fantasia "> </input>
                                                        <input name="image" type="text" placeholder="Link Logomarca "> </input>
                                                        <input name="document" type="text" placeholder="CPF /CNPJ"> </input>
                                                        <input name="number" type="number" placeholder="Numero de Telefone"> </input>
                                                        <input name="url_to_sell" type="text" placeholder="Portal de Vendas"> </input>
                                                        <input name="password" type="number" placeholder="Senha"> </input>
