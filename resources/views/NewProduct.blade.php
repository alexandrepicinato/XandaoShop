                                        ...
                                        <div>
                                            <div class="formulario">
                                                <div>
                                                    ...
                                                    <h4>Crie Seu Produto</h4>
                                                </div>
                                                <form enctype='multipart/form-data' method="POST" action="./action">
                                                    @csrf
                                                        <input name="name" type="text" placeholder="Nome do Produto"> </input>
                                                        <input name="image" type="text" placeholder="Link Imagem do Produto"> </input>

                                                        <input name="description" type="text" placeholder="Descricao do Produto"> </input>
                                                        <input name="value" type="number" placeholder="Valor Normal do Produto"> </input>
                                                        <input name="promovalue" type="number" placeholder="Valor Promocional do Produto"> </input>
